    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table>
                ...
                ?>
                <td><?php echo $this->Html->link("Add", array('controller' => 'TimeLosses', 'action' => 'add'), array('class' => 'btn btn-primary')); ?>  </td>
                </tr>
            </table>
        </div>
    </div>
    <table class="col-md-12 table-bordered table-striped table-condensed cf">
        ...
        <?php foreach ($timeLosses as $timeLoss): ?>
            <tr>
                ...
                <td class="actions">
                    <?php echo $this->Html->link(__('View'), array('action' => 'view', $timeLoss['TimeLoss']['id'])); ?>
