            ...
            <div class="panel-footer">
                ...
                <table class="table table-bordered table-hover">
                    <tr  class="success">
                        ...
                        <td class="text-center"><?=$this->Html->link('Edit', array('action' => 'edit',$consumptions[$i]['TblConsumptionStock']['id'])); ?>  ||  <?php echo $this->Html->link('Delete', array('action' => 'delete', $consumptions[$i]['TblConsumptionStock']['id']),  array('confirm' => 'Are you sure you wish to delete this item? This can\'t undone')); ?>  </td>
                        <?php endfor;?>
                    </tr>
                    <tr class="success">
                        <td>Nepalidate</td>
